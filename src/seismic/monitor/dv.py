...
Last Modified: Monday, 6th March 2023 11:34:00 am
'''
...
class DV(object):
    ...
    def smooth_sim_mat(self, win_len: int, exclude_corr_below: float = 0.):
        """
        ...
        :param exclude_corr_below: Exclude data points with a correlation
            coefficient below the chosen threshold. Defaults to 0 (i.e.,
            include all)
